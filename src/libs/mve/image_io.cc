...
// 	std::cout << "pass00" << std::endl;//2017/06/06
...
// 			std::cout << "PNG_COLOR_TYPE_RGB" << std::endl;
			break;
        case 4: color_type = PNG_COLOR_TYPE_RGB_ALPHA; 
...
// 	std::cout << "pass01" << std::endl;//2017/06/06
...
// 	std::cout << "pass02" << std::endl;//2017/06/06
    /* Setup row pointers. */
    std::vector<png_bytep> row_pointers;
...
// 	std::cout << "pass03" << std::endl;//2017/06/06
    /* Write to file. */
    png_set_rows(png_ptr, info_ptr, &row_pointers[0]);
// 	std::cout << "pass04" << std::endl;//2017/06/06
    png_write_png(png_ptr, info_ptr, png_transforms, nullptr);
// 	std::cout << "pass05" << std::endl;//2017/06/06
    png_write_end(png_ptr, info_ptr);
// 	std::cout << "pass06" << std::endl;//2017/06/06
    /* Cleanup. */
    png_destroy_write_struct(&png_ptr, &info_ptr);
    std::fclose(fp);
}
