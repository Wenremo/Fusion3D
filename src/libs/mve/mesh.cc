...
TriangleMesh::recalc_normals (bool face, bool vertex)
{
    ...
    if (face)
    {
		...
		std::cout << "calculate face normals:06/09/2017" << std::endl;
    }
    ...
    if (vertex)
    {
		...
		std::cout << "calculate vertex normals:06/09/2017" << std::endl;
    }
	...
	std::cout << "face normal count:" << this->face_normals.size() << std::endl << "vertex normal count:" << this->vertex_normals.size() << std::endl;
    if (zlfn || zlvn)
