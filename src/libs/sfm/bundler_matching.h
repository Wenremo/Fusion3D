...
public:
	...
	bool filteringMatches(sfm::Correspondences2D2D &unfiltered_matches, sfm::CorrespondenceIndices &unfiltered_indices, sfm::CorrespondenceIndices &filtered_indices);//added at 07/07/2022
private:
